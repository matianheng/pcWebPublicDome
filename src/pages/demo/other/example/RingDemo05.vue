...
function calc(r: number, strokePercent: number, strokeWidth: number) {
  ...
  return { C, stroke, blankLen, offset }
}
/**
 * 圆半径
 */
...
// 计算第一个圆的有色边框长度stroke，无色边框长度blankLen，stroke偏移量offset
const { stroke, blankLen, offset } = calc(r, 0.65, strokeWidth)

const r2 = 40
const strokeWidth2 = 5
const { stroke: stroke2, blankLen: blankLen2 } = calc(r2, 0, strokeWidth2)
let offset2 = offset
